...
class ChangePasswordInitialPage extends StatefulWidget {
  static final String routeName = 'changePassword';

  @override
  _ChangePasswordInitialPageState createState() => _ChangePasswordInitialPageState();
}

class _ChangePasswordInitialPageState extends State<ChangePasswordInitialPage> {
